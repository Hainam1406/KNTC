    ...
    public class DanhMucCoQuanDAL_v2
    {
        ...
        public BaseResultModel ThemMoi(AddDanhMucCoQuanMOD item)
        {
            ...
            try
            {
                ...
                parameters[1].Value = item.CoQuanChaID;
                parameters[2].Value = item.CapID;
                parameters[3].Value = item.ThamQuyenID;
                parameters[4].Value = item.TinhID;
                parameters[5].Value = item.HuyenID;
                parameters[6].Value = item.XaID;
                parameters[7].Value = item.CapUBND;
                parameters[8].Value = item.CapThanhTra;
                parameters[9].Value = item.CQCoHieuLuc;
                parameters[10].Value = item.SuDungPM;
                parameters[11].Value = item.MaCQ;
                parameters[12].Value = item.SuDungQuyTrinh;
                parameters[13].Value = item.SuDungQuyTrinhGQ;
                parameters[14].Value = item.QTVanThuTiepNhanDon;
                parameters[15].Value = item.QTVanThuTiepDan;
        ...
        public BaseResultModel CapNhat(UpdateDanhMucCoQuanMOD item)
        {
            ...
            try
            {
                ...
                parameters[2].Value = item.CoQuanChaID;
                parameters[3].Value = item.CapID;
                parameters[4].Value = item.ThamQuyenID;
                parameters[5].Value = item.TinhID;
                parameters[6].Value = item.HuyenID;
                parameters[7].Value = item.XaID;
                parameters[8].Value = item.CapUBND;
                parameters[9].Value = item.CapThanhTra;
                parameters[10].Value = item.CQCoHieuLuc;
                parameters[11].Value = item.SuDungPM;
                parameters[12].Value = item.MaCQ;
                parameters[13].Value = item.SuDungQuyTrinh;
                parameters[14].Value = item.SuDungQuyTrinhGQ;
                parameters[15].Value = item.QTVanThuTiepNhanDon;
                parameters[16].Value = item.QTVanThuTiepDan;
                using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                {
                    conn.Open();
                    using (SqlTransaction trans = conn.BeginTransaction())
