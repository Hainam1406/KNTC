    ...
    public class XLD04DAL
    {
        public List<TableData> XLD04(List<int> listCapChonBaoCao, string ContentRootPath, int RoleID, int CapID, int CoQuanDangNhapID, int CanBoDangNhapID, int TinhDangNhapID, int HuyenDangNhapID, DateTime startDate, DateTime endDate)
        {
            ...
            foreach (DataRow dro in dt.Rows)
            {
                ...
                int col14 = Utils.ConvertToInt32(dro["Col15Data"], 0);
                int col15 = Utils.ConvertToInt32(dro["Col16Data"], 0);
                int col16 = Utils.ConvertToInt32(dro["Col17Data"], 0);

                int col22 = Utils.ConvertToInt32(dro["Col27Data"], 0);
                int col23 = Utils.ConvertToInt32(dro["Col28Data"], 0);

                int col1 = col2 + col3 + col4 + col5;
                int col12 = col13 + col14 + col15 + col16;
                int col21 = col22 + col23;
