    ...
    public class XLD02DAL
    {
        public List<TableData> XLD02(List<int> listCapChonBaoCao, string ContentRootPath, int RoleID, int CapID, int CoQuanDangNhapID, int CanBoDangNhapID, int TinhDangNhapID, int HuyenDangNhapID, DateTime startDate, DateTime endDate)
        {
            ...
            foreach (DataRow dro in dt.Rows)
            {
                ...
                int col15 = Utils.ConvertToInt32(dro["Col15Data"], 0);
                int col16 = Utils.ConvertToInt32(dro["Col16Data"], 0);
                int col17 = Utils.ConvertToInt32(dro["Col17Data"], 0);
                ...
                int col29 = Utils.ConvertToInt32(dro["Col29Data"], 0);


                int col1 = col2 + col3 + col4 + col5;
                int col6 = col7 + col8;
                int col10 = col11 + col15 + col16 + col17;
                int col23 = col24 + col25;
                int col26 = col27 + col28 + col29;
