...
namespace Com.Gosol.KNTC.DAL.TiepDan
{
    public class TiepDan
    {
        ...
        private void SetInsertParmsDonThu(SqlParameter[] parms, TiepDanInfo tdInfo)
        {
            ...
            parms[0].Value = tdInfo.NhomKNID;
            parms[1].Value = tdInfo.DoiTuongBiKNID;
            parms[2].Value = tdInfo.LoaiKhieuTo1ID;
            parms[3].Value = tdInfo.LoaiKhieuTo2ID;
            parms[4].Value = tdInfo.LoaiKhieuTo3ID;
            parms[5].Value = tdInfo.LoaiKhieuToID;
            parms[6].Value = tdInfo.NoiDungDon;
            parms[7].Value = tdInfo.TrungDon;
            parms[8].Value = tdInfo.TinhID;
            parms[9].Value = tdInfo.HuyenID;
            parms[10].Value = tdInfo.XaID;
            parms[11].Value = tdInfo.LeTanChuyen;
            ...
            {
                parms[12].Value = tdInfo.NgayVietDon;
            }

            if (tdInfo.DoiTuongBiKNID == 0) parms[1].Value = DBNull.Value;
            parms[13].Value = tdInfo.DiaChiPhatSinh;
        }
        ...
        {
            parms[0].Value = tdInfo.DonThuID;
            parms[1].Value = tdInfo.NhomKNID;
            parms[2].Value = tdInfo.DoiTuongBiKNID;
            parms[3].Value = tdInfo.LoaiKhieuTo1ID;
            parms[4].Value = tdInfo.LoaiKhieuTo2ID;
            parms[5].Value = tdInfo.LoaiKhieuTo3ID;
            parms[6].Value = tdInfo.LoaiKhieuToID;
            parms[7].Value = tdInfo.NoiDungDon;
            parms[8].Value = tdInfo.TrungDon;
            parms[9].Value = tdInfo.TinhID;
            parms[10].Value = tdInfo.HuyenID;
            parms[11].Value = tdInfo.XaID;
            parms[12].Value = tdInfo.LeTanChuyen;
            if (tdInfo.NgayVietDon == DateTime.MinValue)
            {
            ...
            {
                parms[13].Value = tdInfo.NgayVietDon;
            }
            if (tdInfo.DoiTuongBiKNID == 0) parms[2].Value = DBNull.Value;
            parms[14].Value = tdInfo.DiaChiPhatSinh;
        ...
        private void SetInsertParmsXuLyDon(SqlParameter[] parms, TiepDanInfo tdInfo)
        {
            ...
            parms[0].Value = tdInfo.DonThuID;
            parms[1].Value = tdInfo.SoLan;
            parms[2].Value = tdInfo.SoDonThu;

            if (tdInfo.NgayNhapDon == DateTime.MinValue)
                parms[3].Value = DBNull.Value;
            else
                parms[3].Value = tdInfo.NgayNhapDon;

            if (tdInfo.NgayQuaHan == DateTime.MinValue)
                parms[4].Value = DBNull.Value;
            else
            {
                parms[4].Value = tdInfo.NgayQuaHan;
            }
            parms[5].Value = tdInfo.NguonDonDen;
            parms[6].Value = tdInfo.CQChuyenDonID;
            parms[7].Value = tdInfo.SoCongVan;
            ...
            {
                parms[8].Value = tdInfo.NgayChuyenDon;
            }
            parms[9].Value = tdInfo.ThuocThamQuyen;
            parms[10].Value = tdInfo.DuDieuKien;
            parms[11].Value = tdInfo.HuongGiaiQuyetID;
            parms[12].Value = tdInfo.NoiDungHuongDan;
            parms[13].Value = tdInfo.CanBoXuLyID;
            parms[14].Value = tdInfo.CanBoKyID;
            parms[15].Value = tdInfo.CQDaGiaiQuyetID;
            parms[16].Value = tdInfo.TrangThaiDonID;
            parms[17].Value = tdInfo.PhanTichKQID;
            parms[18].Value = tdInfo.CanBoTiepNhapID;
            parms[19].Value = tdInfo.CoQuanID;
            if (tdInfo.NgayThuLy == DateTime.MinValue)
                parms[20].Value = DBNull.Value;
            else
                parms[20].Value = tdInfo.NgayThuLy;

            parms[21].Value = tdInfo.LyDo;
            parms[22].Value = tdInfo.DuAnID;
            if (tdInfo.NgayXuLy != DateTime.MinValue)
                parms[23].Value = tdInfo.NgayXuLy;
            else
                parms[23].Value = DBNull.Value;
            parms[24].Value = tdInfo.DaDuyetXuLy;
            parms[25].Value = tdInfo.CQChuyenDonDenID;
            parms[26].Value = tdInfo.CBDuocChonXL;
            parms[27].Value = tdInfo.QTTiepNhanDon;
            parms[28].Value = tdInfo.DonThuGocID;
            parms[29].Value = tdInfo.LanGiaiQuyet;
            ...
            parms[30].Value = tdInfo.XuLyDonIDGoc;
        }
        ...
        {
            parms[0].Value = tdInfo.XuLyDonID;
            parms[1].Value = tdInfo.DonThuID;
            parms[2].Value = tdInfo.SoLan;
            if (tdInfo.NgayNhapDon == DateTime.MinValue)
            {
                parms[3].Value = DBNull.Value;
            }
            ...
            parms[24].Value = tdInfo.CBDuocChonXL;
            parms[25].Value = tdInfo.QTTiepNhanDon;
            parms[26].Value = tdInfo.DonThuGocID;
            parms[27].Value = tdInfo.LanGiaiQuyet;
        ...
        private void SetInsertParmsTiepDan(SqlParameter[] parms, TiepDanInfo tdInfo)
        {
            ...
            parms[0].Value = tdInfo.NgayTiep;
            parms[1].Value = tdInfo.GapLanhDao;
            if (tdInfo.NgayGapLanhDao == DateTime.MinValue)
                parms[2].Value = DBNull.Value;
            else
                parms[2].Value = tdInfo.NgayGapLanhDao;
            parms[3].Value = tdInfo.NoiDungTiep;
            parms[4].Value = tdInfo.VuViecCu;
            parms[5].Value = tdInfo.CanBoTiepID;
            parms[6].Value = tdInfo.DonThuID;
            parms[7].Value = tdInfo.CoQuanID;
            parms[8].Value = tdInfo.XuLyDonID;
            parms[9].Value = tdInfo.LanTiep;
            parms[10].Value = tdInfo.KetQuaTiep;
            parms[11].Value = tdInfo.SoDon;
            parms[12].Value = tdInfo.NhomKNID;
            parms[13].Value = tdInfo.LoaiKhieuTo1ID;
            parms[14].Value = tdInfo.LoaiKhieuTo2ID;
            parms[15].Value = tdInfo.LoaiKhieuTo3ID;
            parms[16].Value = tdInfo.TenLanhDaoTiep;
            parms[17].Value = tdInfo.LanhDaoDangKy;
            parms[18].Value = tdInfo.KQQuaTiepDan;
            parms[19].Value = tdInfo.YeuCauNguoiDuocTiep;
            parms[20].Value = tdInfo.ThongTinTaiLieu;
            parms[21].Value = tdInfo.KetLuanNguoiChuTri;
            parms[22].Value = tdInfo.NguoiDuocTiepPhatBieu;
        ...
        private void SetUpdateParmsTiepDan(SqlParameter[] parms, TiepDanInfo tdInfo)
        {
            ...
            else { parms[1].Value = tdInfo.NgayTiep; }
            parms[2].Value = tdInfo.GapLanhDao;
            if (tdInfo.NgayGapLanhDao == DateTime.MinValue)
            {
                parms[3].Value = DBNull.Value;
            }
            ...
            {
                parms[3].Value = tdInfo.NgayGapLanhDao;
            }

            parms[4].Value = tdInfo.NoiDungTiep;
            parms[5].Value = tdInfo.VuViecCu;
            parms[6].Value = tdInfo.CanBoTiepID;
            parms[7].Value = tdInfo.DonThuID;
            parms[8].Value = tdInfo.CoQuanID;
            parms[9].Value = tdInfo.XuLyDonID;
            parms[10].Value = tdInfo.LanTiep;
            parms[11].Value = tdInfo.KetQuaTiep;
            parms[12].Value = tdInfo.NhomKNID;
            parms[13].Value = tdInfo.LoaiKhieuTo1ID;
            parms[14].Value = tdInfo.LoaiKhieuTo2ID;
            parms[15].Value = tdInfo.LoaiKhieuTo3ID;
            ...
            parms[17].Value = tdInfo.KQQuaTiepDan;
            parms[18].Value = tdInfo.YeuCauNguoiDuocTiep;
            parms[19].Value = tdInfo.ThongTinTaiLieu;
            parms[20].Value = tdInfo.KetLuanNguoiChuTri;
            parms[21].Value = tdInfo.NguoiDuocTiepPhatBieu;
        }
        #endregion
        ...
        public int UpdateTiepDan(TiepDanInfo tdInfo)
        {
            ...
            using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    ...
                    try
                    {
                        val = SQLHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, UPDATE_TIEPDAN_NEW, parameters);
                        trans.Commit();
                    }
                    catch
                    {
        ...
        public TiepDanInfo GetTiepDanByTiepDanID(int tiepdanID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, CommandType.StoredProcedure, GET_TIEPDAN_BY_TIEPDANID, parameters))
                {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, CommandType.StoredProcedure, CHECK_TRUNG_DON_BY_HOTEN, parameters))
                {
                    while (dr.Read())
                    {
                        ...
                        DTInfo.TenCoQuan = Utils.GetString(dr["TenCoQuan"], string.Empty);
                        DTInfo.SoLan = new TiepDan().CoundTrungDon(DTInfo.DonThuID);
        ...
        private TiepDanInfo GetDataCTTrungDon(SqlDataReader dr)
        {
            ...
            info.NgayNhapDon_Str = Ultilities.Format.FormatDate(info.NgayNhapDon);
        ...
        public int InsertDanKhongDen(TiepCongDan_DanKhongDenInfo dkdInfo)
        {
            ...
            if (dkdInfoTemp != null && dkdInfoTemp.DanKhongDenID > 0)
            {
                using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                {
                    ...
                    param[4].Value = dkdInfoTemp.DanKhongDenID;
                    ...
                    using (SqlTransaction trans = conn.BeginTransaction())
                    {
                        ...
                        try
                        {
                            ...
                            trans.Commit();
                            if (Utils.ConvertToInt32(val, 0) > 0) val = dkdInfoTemp.DanKhongDenID;
                        }
                        catch
                        {
                            trans.Rollback();
