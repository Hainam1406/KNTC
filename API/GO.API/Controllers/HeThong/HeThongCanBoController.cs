...
namespace Com.Gosol.KNTC.API.Controllers.HeThong
{
    ...
    public class HeThongCanBoController : BaseApiController
    {
        ...
        [HttpPost]
        //[CustomAuthAttribute(ChucNangEnum.NhanVien, AKNTCessLevel.Create)]
        [Route("Insert")]
        ...
        [HttpGet]
        //[CustomAuthAttribute(ChucNangEnum.HeThong_QuanLy_CanBo, AKNTCessLevel.Read)]
        [Route("GetByID")]
        ...
        [HttpGet]
        //[CustomAuthAttribute(ChucNangEnum.HeThong_QuanLy_CanBo, AKNTCessLevel.FullAKNTCess)]
