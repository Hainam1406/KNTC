    ...
    public class Commons
    {
        ...
        public async Task<FileDinhKemModel> InsertFileAsync(IFormFile source, FileDinhKemModel FileDinhKem, IHostingEnvironment _host)
        {
            try
            {
                ...
                fileInfo.TomTat = FileDinhKem.TomTat;
                fileInfo.NghiepVuID = FileDinhKem.NghiepVuID;
                fileInfo.DonThuID = FileDinhKem.DonThuID;
                fileInfo.XuLyDonID = FileDinhKem.XuLyDonID;
        ...
        // v2
        public async Task<FileDinhKemModel> InsertFileAsync_v2(IFormFile source, FileDinhKemModel FileDinhKem, IHostingEnvironment _host)
        {
            try
            {
                FileDinhKemModel fileInfo = new FileDinhKemModel();
                string TenFileGoc = ContentDispositionHeaderValue.Parse(source.ContentDisposition).FileName.Trim('"');
                string TenFileHeThong = DateTime.Now.ToString("yyyy-MM-dd-HHmmss") + "_" + TenFileGoc;
